...
- Version realigned to track the private source's executor-doctrine v2 release. This mirror's parallelism table was already model-tier-generic ("never delegated to a fixed lower-tier model") -- no content change needed.
